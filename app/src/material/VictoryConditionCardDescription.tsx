...
import SnakeVictoryCondition from '../images/cards/snake/victory-condition.jpg'
 ...
 * It has no back here: it is never shown face down. The emblem of the clan is what illustrates the clan in the
 * choice dialog, where it is used directly (see clanEmblems in ClanCardDescription).
 */
export class VictoryConditionCardDescription extends LedaCardDescription<Clan> {
  ...
  images: Record<Clan, string> = {
    ...
    [Clan.Snake]: SnakeVictoryCondition
  }
