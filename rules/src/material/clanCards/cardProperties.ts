 ...
 */
export const clanCardProperties: Record<ClanCardId, ClanCardProperties> = { ...catCards, ...sharkCards, ...scorpionCards }

/**
 * What playing a card costs its owner in Food, and undefined when it cannot be bought with Food at all: the 4
 * Rings, which are played for free once their condition is met, and the 3 Cat cards paid with cards from the hand.
 * TODO: those 3, once there is somewhere to discard cards to.
 *
